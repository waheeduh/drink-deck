-- *************************************************************
-- This script creates the drinkdeck_db database
-- for Drink Deck.
-- *************************************************************

-- Create the database
DROP DATABASE IF EXISTS drinkdeck_db;
CREATE DATABASE drinkdeck_db;
...
CREATE TABLE drinks (
    ...
    temperature			ENUM('cold', 'hot')					NOT NULL
);
...
INSERT INTO drinks (drink_name, drink_description, drink_price, ingredients, temperature) VALUES 
-- COLD DRINKS
('Iced Coffee', 'Refreshing iced coffee made with freshly brewed coffee, milk, and ice.', 3.99, 'Coffee, Milk, Ice', 'cold'),
('Iced Latte', 'Chilled latte made with espresso, milk, and ice.', 4.49, 'Espresso, Milk, Ice', 'cold'),
('Lemonade', 'Classic lemonade made with freshly squeezed lemons and sugar.', 2.99, 'Lemon Juice, Sugar, Water, Ice', 'cold'),
('Strawberry Lemonade', 'Tangy lemonade infused with fresh strawberries.', 3.49, 'Lemonade, Strawberry Puree, Ice', 'cold'),
('Blueberry Smoothie', 'Creamy smoothie made with blueberries, yogurt, and honey.', 4.99, 'Blueberries, Yogurt, Honey, Ice', 'cold'),
('Mango Smoothie', 'Refreshing smoothie made with ripe mangoes, yogurt, and ice.', 5.49, 'Mangoes, Yogurt, Ice', 'cold'),
('Berry Blast Smoothie', 'A burst of berry flavors with strawberries, blueberries, and raspberries.', 5.99, 'Strawberries, Blueberries, Raspberries, Yogurt, Ice', 'cold'),
('Red Bull', 'Energy drink to give you wings, with a fruity flavor.', 2.79, 'Carbonated Water, Sugar, Caffeine, Taurine, B-Vitamins', 'cold'),
('Monster Energy', 'High-energy drink with a bold flavor.', 3.49, 'Carbonated Water, Sugar, Caffeine, Taurine, B-Vitamins', 'cold'),
('Rockstar Energy', 'Power-packed energy drink with a tropical twist.', 3.29, 'Carbonated Water, Sugar, Caffeine, Taurine, B-Vitamins', 'cold'),
('Dasani Spring Water', 'Refreshing spring water sourced from natural springs.', 1.49, 'Spring Water', 'cold'),
('Evian Spring Water', 'Premium natural spring water imported from France.', 2.99, 'Spring Water', 'cold'),
('Coca-Cola', 'Classic cola with a refreshing taste.', 1.99, 'Carbonated Water, Sugar, Caramel Color, Phosphoric Acid, Natural Flavors, Caffeine', 'cold'),
('Pepsi', 'Refreshing cola with a hint of citrus.', 1.99, 'Carbonated Water, Sugar, Caramel Color, Phosphoric Acid, Natural Flavors, Caffeine', 'cold'),
('Sprite', 'Crisp lemon-lime soda.', 1.79, 'Carbonated Water, Sugar, Citric Acid, Natural Flavors, Sodium Citrate', 'cold'),
-- HOT DRINKS
('Hot coffee', 'Freshly brewed coffee with your choice of milk and sweetness', 3.99, 'Instant coffee, water, sugar', 'hot'),
('Hot Chocolate', 'Creamy chocolatey sweet goodness topped with soft marshmellows', 5.99, 'Cocoa powder, sugar, milk, marshmallows', 'hot'),
('Hot Apple Cider', 'A soothing blend of crisp apples and warm spices', 3.99, 'Apple cider, maple syrup, cinnamon', 'hot'),
('Adeni Chai', 'A traditional Yemeni tea infused with fragrant spices and brewed to perfection with your choice of milk', 5.99, 'Pekoe tea bags, evaporated milk, sugar, cardamom, cinnamon, nutmeg', 'hot'),
('Punjabi Chai', 'A traditional Indian tea brewed with fragrant spices and rich black tea leaves', 6.99, 'fennel seeds, cardamom, black tea, milk', 'hot'),
('Latte', 'Freshly brewed coffee with your choice of milk and syrup', 4.99, 'coffeem milk, sugar', 'hot'),
('Matcha Latte', 'Vibrant matcha with creamy milk and sugar', 6.99, 'Matcha, water, coconut milk, sugar', 'hot'),
('Fresh Ginger Tea', 'Soothing ginger tea with your choice of sweetner', 3.99, 'ginger, water, lemon', 'hot'),
('Gingerbread Latte', 'a comforting blend of rich espresso, steamed milk, and warm gingerbread spices, topped with a velvety foam', 4.99, 'Gingerbread syrup, espresso, nutmeg, milk', 'hot'),
('Caramal Machiatto','bold espresso, velvety steamed milk, and swirls of luscious caramel', 5.99, 'Milk, vanilla syrup, espresso, caramel sauce', 'hot'),
('Green Tea', 'Soothing green tea with your choice of sweetner', 2.99, 'Green Tea, Honey, Lemon', 'hot'),
('Black Tea', 'Soothing black tea with your choice of sweetner', 3.99, 'Black Tea, sugar', 'hot'),
('Mocha Latte', 'Espresso with velvety steamed milk and decadent chocolate', 4.99, 'espresso, milk, choclate chips, whipped cream', 'hot'),
('Hot Cranberry Cider', 'Soothing hot cranberry cider with your choice of sweetner', 3.99, 'apple cider, cranberry, lemon, cinnamon', 'hot'),
('Mint Tea', 'Refreshing mint tea with your choice of sweetner', 2.99, 'mint, lemon, sweetener', 'hot');
...
(1, 5, 1, 'Medium', 'Regular', NULL, 1, 4.99, '2024-02-02'),
(1, 3, 1, 'Medium', 'Regular', NULL, 1, 4.99, '2024-02-02'),
(8, 12, NULL, 'Large', 'Extra', NULL, 1, 6.99, '2024-01-25'),
(8, 7, NULL, 'Small', 'Regular', NULL, 1, 3.99, '2024-02-20'),
(8, 4, NULL, 'Large', 'Less', NULL, 1, 4.99, '2024-03-30'),
(15, 33, 3, 'Small', 'Less', NULL, 1, 3.99, '2024-03-12'),
(27, 13, 2, 'Medium', 'Extra', NULL, 1, 1.99, '2024-01-07'),
(40, 11, 1, 'Small', 'Regular', 4, 1, 3.99, '2024-01-20'),
(40, 15, NULL, 'Medium', 'Extra', 4, 1, 4.99, '2024-02-13'),
(40, 18, 2, 'Small', 'Less', 4, 1, 5.99, '2024-03-03'),
(40, 19, 3, 'Large', 'Regular', 4, 1, 3.99, '2024-03-30'),
(40, 15, 4, 'Large', 'Regular', 4, 1, 4.99, '2024-04-01'),
(40, 17, NULL, 'Small', 'Regular', 4, 1, 5.99, '2024-04-03');

INSERT INTO UI (ui_type, element_contents, element_shape, element_description) VALUES 
