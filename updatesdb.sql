...
-- HOT DRINKS
('Hot coffee', 'Freshly brewed coffee with your choice of milk and sweetness', 3.99, 'Instant coffee, water, sugar' ),
('Hot Chocolate', 'Creamy chocolatey sweet goodness topped with soft marshmellows', 5.99, 'cocoa powder, sugar, milk, marshmellows'),
('Hot Apple Cider', 'A soothing blend of crisp apples and warm spices', 3.99, 'apple cider, maple syrup, cinnamon'),
('Adeni Chai', 'A traditional Yemeni tea infused with fragrant spices and brewed to perfection with your choice of milk', 5.99, 'pekoe tea bags, evaporated milk, sugar, cardamom, cinnamon, nutmeg'),
('Punjabi Chai', 'A traditional Indian tea brewed with fragrant spices and rich black tea leaves', 6.99, 'fennel seeds, cardamom, black tea, milk'),
('Latte', 'Freshly brewed coffee with your choice of milk and syrup', 4.99, 'coffeem milk, sugar'),
('Matcha Latte', 'Vibrant matcha with creamy milk and sugar', 6.99, 'Matcha, water, coconut milk, sugar'),
('Fresh Ginger Tea', 'Soothing ginger tea with your choice of sweetner', 3.99, 'ginger, water, lemon'),
('Gingerbread Latte', 'a comforting blend of rich espresso, steamed milk, and warm gingerbread spices, topped with a velvety foam', 4.99, 'gingerbread syrup, espresso, nutmeg, milk'),
('Caramal Machiatto','bold espresso, velvety steamed milk, and swirls of luscious caramel', 5.99, 'milk, vanilla syrup, espresso, caramel sauce'),
('Green Tea', 'Soothing green tea with your choice of sweetner', 2.99, 'Green Tea, Honey, Lemon'),
('Black Tea', 'Soothing black tea with your choice of sweetner', 3.99, 'Black Tea, sugar'),
('Mocha Latte', 'Espresso with velvety steamed milk and decadent chocolate', 4.99, 'espresso, milk, choclate chips, whipped cream'),
('Hot Cranberry Cider', 'Soothing hot cranberry cider with your choice of sweetner', 3.99, 'apple cider, cranberry, lemon, cinammon'),
('Mint Tea', 'Refreshing mint tea with your choice of sweetner', 2.99, 'mint, lemon, sweetner');
...
(6, 'water', 0.00),
(7, 'decaf coffee', 0.50),
(8, 'Protien Powder', 1.00),
(9, 'sparkling water', 0.75);
